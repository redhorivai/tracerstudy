...
class Kuisoner extends BaseController
{
  ...
  //   	$data = [
		...
		// ];
  //       return view('admin/kuisoner',$data);
  //   }
    ...
    public function daftarkuisoner()
    {
        ...
        return view('admin/daftarkuisoner',$data);
    }
        ...
        if (count($jawaban) > 0) {
            ...
            foreach ($jawaban as $j) {
                ...
                if ($j->jawaban_format == "radio") {
                    $taginput = "<input style='margin-right:10px;' type='radio' value='$jawaban_id' data-nilai='' data-sub_soal_id='$sub_soal_id' name='jawaban_id_${soal_id}_${sub_soal_id}' id='jawaban_id'/>" . $j->jawaban_cd . ".<span style='margin-left:10px;'>" . $j->jawaban_nm . "</span>";
                } else if ($j->jawaban_format == "multiple") {
                    $taginput = "<input type='checkbox' value='$jawaban_id' data-nilai='' data-sub_soal_id='$sub_soal_id' name='jawaban_id_${soal_id}_${jawaban_id}' id='jawaban_id'/>";
                } else if ($j->jawaban_format == "input") {
                    $taginput = $j->jawaban_cd . "<span style='margin-left:30px;'>" . $j->jawaban_nm . "</span> <input style='margin-left:25px;margin-right:20px;width:350px;' type='text' value='' data-nilai='' data-sub_soal_id='$sub_soal_id' name='jawaban_id_${soal_id}_${jawaban_id}'  id='jawaban_id'/>";
                    ...
                    for ($i = 1; $i <= $jmlinp; $i++) {
                        ...
                        $arrtaginput .=  "<label class='lb_radio_square'><input class='inp_radio_range' type='radio' value='$jawaban_id' data-nilai='$i' data-sub_soal_id='$sub_soal_id' name='subjawaban_id_${soal_id}_${jawaban_id}' id='subjawaban_id'/><span class='sp_radio_square'></span></label>";
                    }
    ...
    public function laporankuisoner2()
    {
        $ret = "";
        $class_soal = $this->modelsoal->getAllClassSoal()->getResult();
        if (count($class_soal) > 0) {
        ...
        return view('admin/laporankuisoner',$data);
    }
    ...
    public function laporankuisoner()
    {
        ...
        $data = [
            'sebaranalumnuspersen' => $this->modelsoal->sebaranalumnuspersen()->getResult(),
            'ttljml' => $this->modelsoal->totalalumnus()->getResult(),
            'mengisibelum' => $this->modelsoal->mengisibelum()->getResult(),
        ];
        return view('admin/laporankuisoner',$data);
    }
}
